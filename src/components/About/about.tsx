      ...
      <div className="content-about">
        <div className="content-profile">
          ...
          <div className="icon-social">
            ...
            <a href="https://twitter.com/beerinjection" target="_blank" rel="noreferrer">
              <BsTwitter />
            </a>
          </div>
        </div>
        ...
        <div className="content-profile">
          ...
          <div className="profile">
            ...
            <span>Front-end Develop Jr | Postgraduate in Software Engineering</span>
          </div>
          ...
          <div className="icon-social">
            ...
            <a href="https://github.com/williamscalado/" target="_blank" rel="noreferrer">
              <BsGithub />
            </a>
            ...
            <a href="https://twitter.com/williamscalado" target="_blank" rel="noreferrer">
              <BsTwitter />
            </a>
          </div>
        </div>
